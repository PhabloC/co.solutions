...
import { ShaderBackgroundProps, ShaderPlaneProps } from "./types";
    ...
    >
      ...
      <div className="relative z-10 flex h-svh w-full items-center justify-center px-6">
        <div className="text-center">
          <h1
            ref={h1Ref}
            className="mx-auto max-w-2xl lg:max-w-4xl text-[clamp(2.25rem,6vw,4rem)] font-extralight leading-[0.95] tracking-tight text-white"
          >
          ...
          >
            Desenvolvemos sites profissionais e landing pages de alta conversão
            que elevam seu negócio ao próximo nível
          </p>
          ...
          >
            <Button variant="glass">Entrar em contato</Button>
          </div>
        </div>
      </div>
    </div>
